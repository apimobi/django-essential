...
def test_signup_endpoint_redirects_authenticated_user(client):
    '''
        When a user is authenticated and try to access the signup page
        they are redirected to notes list page
    '''
    user = User.objects.create_user('Clara', 'calara@example.com', 'password')
